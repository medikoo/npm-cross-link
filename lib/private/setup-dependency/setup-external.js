...
const nonOverridableExternals = new Set(["npm"]);
...
module.exports = async (dependencyContext, progressData) => {
	...
	if (!versionRange && latestVersion) {
		dependencyContext.versionRange = latestVersion;
		dependencyContext.latestSupportedPublishedVersion = latestVersion;
	}
