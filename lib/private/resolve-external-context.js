...
const optionalChaining = require("es5-ext/optional-chaining")
    ...
    , getMetadata      = require("./setup-dependency/get-metadata");
...
module.exports = async (dependencyContext, progressData) => {
	...
	if (!dependencyContext.externalContext.metadata) return dependencyContext.externalContext;
	...
	return dependencyContext.externalContext;
};
