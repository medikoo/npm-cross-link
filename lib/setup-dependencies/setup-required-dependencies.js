...
module.exports = async (packageContext, userConfiguration, inputOptions, progressData) => {
	...
	if (
		...
		// Install prod dependencies only if we're installating dependencies of the dependencies
		// or if we're meant to install prod dependencies of the top package
		// (e.g. not just dev dependencies)
